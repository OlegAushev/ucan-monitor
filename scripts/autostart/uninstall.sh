...
echo "Removing '$systemd_user_dir/$systemd_user_service_name'"
...
echo "Removing '$cansocket_system_script'"
...
echo "Removing '$systemd_system_dir/$systemd_system_service_name'"
