...
//##########################################################################################################################################################################################################################################################################################################
{{0x300B, 0x01}, {"config", "hall", "sector_0_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x02}, {"config", "hall", "sector_1_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x03}, {"config", "hall", "sector_2_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x04}, {"config", "hall", "sector_3_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x05}, {"config", "hall", "sector_4_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x06}, {"config", "hall", "sector_5_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x07}, {"config", "hall", "sector_0_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x08}, {"config", "hall", "sector_1_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x09}, {"config", "hall", "sector_2_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x0A}, {"config", "hall", "sector_3_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x0B}, {"config", "hall", "sector_4_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300B, 0x0C}, {"config", "hall", "sector_5_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
//##########################################################################################################################################################################################################################################################################################################
{{0x300C, 0x01}, {"config", "hall_emulator", "sector_0_code",      "",  OD_ACCESS_RW, OD_INT32}},
{{0x300C, 0x02}, {"config", "hall_emulator", "sector_1_code",      "",  OD_ACCESS_RW, OD_INT32}},
{{0x300C, 0x03}, {"config", "hall_emulator", "sector_2_code",      "",  OD_ACCESS_RW, OD_INT32}},
{{0x300C, 0x04}, {"config", "hall_emulator", "sector_3_code",      "",  OD_ACCESS_RW, OD_INT32}},
{{0x300C, 0x05}, {"config", "hall_emulator", "sector_4_code",      "",  OD_ACCESS_RW, OD_INT32}},
{{0x300C, 0x06}, {"config", "hall_emulator", "sector_5_code",      "",  OD_ACCESS_RW, OD_INT32}},
{{0x300D, 0x01}, {"config", "hall_emulator", "sector_0_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x02}, {"config", "hall_emulator", "sector_1_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x03}, {"config", "hall_emulator", "sector_2_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x04}, {"config", "hall_emulator", "sector_3_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x05}, {"config", "hall_emulator", "sector_4_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x06}, {"config", "hall_emulator", "sector_5_entry_pos", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x07}, {"config", "hall_emulator", "sector_0_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x08}, {"config", "hall_emulator", "sector_1_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
{{0x300D, 0x09}, {"config", "hall_emulator", "sector_2_entry_neg", "°",  OD_ACCESS_RW, OD_FLOAT32}},
