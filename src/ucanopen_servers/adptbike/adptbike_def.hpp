...
#include "adptbike_def_sys.hpp"

// PDO layouts mirror src/app/inverter/comm/can/canopen/pdo_layouts.hpp of the
// adpt-bike-inverter firmware. Keep both in sync.
...
struct CobRpdo2 {
  ...
  // Byte 6
  uint8_t model_mode : 3;     // idle/closed/semi/open_I/open_V/direct_pwm
