...
{{0x3005, 0x02}, {"config", "model_basic", "is_motor_max", "A", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3005, 0x03}, {"config", "model_basic", "is_gener_max", "A", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3005, 0x04}, {"config", "model_basic", "if_max", "A", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3005, 0x05}, {"config", "model_basic", "torque_pos_max", "Nm", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3005, 0x06}, {"config", "model_basic", "torque_neg_max", "Nm", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3005, 0x07}, {"config", "model_basic", "speed_rpm_max", "rpm", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3005, 0x08}, {"config", "model_basic", "id_max_flux_weakening", "A", OD_ACCESS_RW, OD_FLOAT32}},
...
{{0x3006, 0x07}, {"config", "model_controllers", "kp_flux_weakening", "", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3006, 0x08}, {"config", "model_controllers", "ki_flux_weakening", "", OD_ACCESS_RW, OD_FLOAT32}},
