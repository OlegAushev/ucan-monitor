...
{{0x5000, 0x31}, {"watch", "angsens",  "mech_angel_d",      "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x32}, {"watch", "angsens",  "mech_absangle_d",   "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x33}, {"watch", "angsens",  "elec_angle_d",      "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x34}, {"watch", "angsens",  "elec_absangle_d",   "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x35}, {"watch", "angsens",  "speed_d",           "rpm",  OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x36}, {"watch", "angsens",  "turns_d",           "",     OD_ACCESS_RO, OD_INT32}},
{{0x5000, 0x37}, {"watch", "angsens",  "mech_angle_a",      "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x38}, {"watch", "angsens",  "mech_absangle_a",   "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x39}, {"watch", "angsens",  "elec_angle_a",      "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x3A}, {"watch", "angsens",  "elec_absangle_a",   "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x3B}, {"watch", "angsens",  "speed_a",           "rpm",  OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x3C}, {"watch", "angsens",  "turns_a",           "",     OD_ACCESS_RO, OD_INT32}},

{{0x5000, 0x41}, {"watch", "temp",  "phase_a",  "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x42}, {"watch", "temp",  "phase_b",  "o",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x43}, {"watch", "temp",  "phase_c",  "o",    OD_ACCESS_RO, OD_FLOAT32}},
