...
{{0x5000, 0x29}, {"watch", "model", "vD",           "V",    OD_ACCESS_RO, OD_FLOAT32}},
{{0x5000, 0x2A}, {"watch", "model", "vQ",           "V",    OD_ACCESS_RO, OD_FLOAT32}},
...
// {{0x5000, 0x36}, {"watch", "angsens",  "turns_d",           "",     OD_ACCESS_RO, OD_FLOAT32}},
...
{{0x5000, 0x3C}, {"watch", "angsens",  "turns_a",           "",     OD_ACCESS_RO, OD_FLOAT32}},
...
{{0x300A, 0x09}, {"config", "calibration", "release_distance",              "mm",       OD_ACCESS_RW, OD_FLOAT32}},
