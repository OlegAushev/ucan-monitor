...
//##############################################################################
{{0x3008, 0x01}, {"config", "pdu", "dclink_charge_threshold",       "V",    OD_ACCESS_RW, OD_FLOAT32}},
{{0x3008, 0x02}, {"config", "pdu", "bypass_voltage_threshold",      "V",    OD_ACCESS_RW, OD_FLOAT32}},
{{0x3008, 0x03}, {"config", "pdu", "dclink_charge_timeout_ms",      "ms",   OD_ACCESS_RW, OD_UINT32}},
{{0x3008, 0x04}, {"config", "pdu", "charging_contactor_holdup_ms",  "ms",   OD_ACCESS_RW, OD_UINT32}},
{{0x3008, 0x05}, {"config", "pdu", "dclink_discharge_threshold",    "V",    OD_ACCESS_RW, OD_FLOAT32}},
{{0x3008, 0x06}, {"config", "pdu", "dclink_discharge_timeout_ms",   "ms",   OD_ACCESS_RW, OD_UINT32}},
{{0x3008, 0x07}, {"config", "pdu", "switch_timeout_ms",             "ms",   OD_ACCESS_RW, OD_UINT32}},
{{0x3008, 0x08}, {"config", "pdu", "pause_ms",                      "ms",   OD_ACCESS_RW, OD_UINT32}},
//##############################################################################
