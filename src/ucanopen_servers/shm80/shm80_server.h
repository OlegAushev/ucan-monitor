...
private:
    ...
    struct {
        ...
        std::atomic<bool> pdu_good{false};
    ...
    struct {
        ...
        std::atomic<bool> throttle_good{false};
...
public:
    ...
    bool pdu_good() const { return _tpdo1.pdu_good.load(); }
    ...
    bool throttle_good() const { return _tpdo3.throttle_good.load(); }
