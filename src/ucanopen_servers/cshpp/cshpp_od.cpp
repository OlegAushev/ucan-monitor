...
// src/app/cshpp/comm/can/canopen/od.cpp of the h2-hess firmware.
...
//##########################################################################################################################################################################################################################################################################################################
{{0x3001, 0x01}, {"config", "gen",  "start_pressure_min",    "atm",   OD_ACCESS_RW, OD_FLOAT32}},
{{0x3001, 0x02}, {"config", "gen",  "storage_ready_timeout", "s",     OD_ACCESS_RW, OD_FLOAT32}},
{{0x3001, 0x03}, {"config", "gen",  "stop_ack_timeout",      "s",     OD_ACCESS_RW, OD_FLOAT32}},
//##########################################################################################################################################################################################################################################################################################################
{{0x3002, 0x01}, {"config", "leak", "flow_peak_th",          "l/min", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3002, 0x02}, {"config", "leak", "flow_steady_th",        "l/min", OD_ACCESS_RW, OD_FLOAT32}},
{{0x3002, 0x03}, {"config", "leak", "flow_steady_time",      "s",     OD_ACCESS_RW, OD_FLOAT32}},
{{0x3002, 0x04}, {"config", "leak", "pressure_diff_th",      "atm",   OD_ACCESS_RW, OD_FLOAT32}},
//##########################################################################################################################################################################################################################################################################################################
{{0x3003, 0x01}, {"config", "sensor", "hydrogen_pressure_installed", "", OD_ACCESS_RW, OD_BOOL}},
{{0x3003, 0x02}, {"config", "sensor", "hydrogen_flow_installed",     "", OD_ACCESS_RW, OD_BOOL}},
//##########################################################################################################################################################################################################################################################################################################
