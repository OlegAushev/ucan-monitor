...
inline const ImVec4 green_button = (ImVec4)ImColor::HSV(0.35f, 0.6f, 0.6f);
inline const ImVec4 green_button_hovered =
        (ImVec4)ImColor::HSV(0.35f, 0.8f, 0.8f);
inline const ImVec4 green_button_active =
        (ImVec4)ImColor::HSV(0.35f, 0.7f, 0.7f);

inline const ImVec4 red_button = (ImVec4)ImColor::HSV(0.0f, 0.6f, 0.6f);
inline const ImVec4 red_button_hovered = (ImVec4)ImColor::HSV(0.0f, 0.8f, 0.8f);
inline const ImVec4 red_button_active = (ImVec4)ImColor::HSV(0.0f, 0.7f, 0.7f);

inline const ImVec4 yellow_button = (ImVec4)ImColor::HSV(0.15f, 0.6f, 0.6f);
inline const ImVec4 yellow_button_hovered =
        (ImVec4)ImColor::HSV(0.15f, 0.8f, 0.8f);
inline const ImVec4 yellow_button_active =
        (ImVec4)ImColor::HSV(0.15f, 0.7f, 0.7f);
